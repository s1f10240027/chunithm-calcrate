...
function getSongsFromDiff(difficulty) {
    let matched = songs.filter((song) => song.dif_exp == difficulty || song.dif_mas == difficulty || song.dif_ult == difficulty);
    let titles = matched.map((song) => song.title);
    let title_genre = {};
